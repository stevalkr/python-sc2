...
UPGRADE_RESEARCHED_FROM: Dict[UpgradeId, UnitTypeId] = {
    ...
    UpgradeId.AMPLIFIEDSHIELDING: UnitTypeId.STARPORTTECHLAB,
    ...
    UpgradeId.MICROBIALSHROUD: UnitTypeId.FLEETBEACON,
    ...
    UpgradeId.TEMPESTGROUNDATTACKUPGRADE: UnitTypeId.FACTORYTECHLAB,
